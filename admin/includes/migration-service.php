              ...
              $post_data = array(
                ...
                'post_type'    => 'quads-ads',
                    ...
                    foreach ($post_meta as $key => $value) {
                        ...
                        }else if($key == 'banner_size'){
                            $banner_size = explode('x', $value[0]);
                            update_post_meta( $post_id, 'g_data_ad_width', esc_html($banner_size[0]));
                            update_post_meta( $post_id, 'g_data_ad_height', esc_html($banner_size[1]));
