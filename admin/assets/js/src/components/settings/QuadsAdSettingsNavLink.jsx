    ...
    return(                             
      ...
      <ul>
        ...
        {/*   {quads_localize_data.sellable_ads == 1 ? <li><h2><Link to={'admin.php?page=quads-settings&path=settings_adsell'} className={current == 'settings_adsell' ? 'quads-nav-link quads-nav-link-active' : 'quads-nav-link'}>{__('Sellable Ads', 'quick-adsense-reloaded')}</Link></h2></li>:''} */}
          {/* {quads_localize_data.disableads == 1 ? <li><h2><Link to={'admin.php?page=quads-settings&path=settings_disableads'} className={current == 'settings_disableads' ? 'quads-nav-link quads-nav-link-active' : 'quads-nav-link'}>{__('Disable Ads', 'quick-adsense-reloaded')}</Link></h2></li>:''} */}
         {/*  {quads_localize_data.disableads == 1 ? <li><h2><Link to={'admin.php?page=quads-settings&path=settings_disableadslist'} className={current == 'settings_disableadslist' ? 'quads-nav-link quads-nav-link-active' : 'quads-nav-link'}>{__('Disabled Ad Users', 'quick-adsense-reloaded')}</Link></h2></li>:''} */}
