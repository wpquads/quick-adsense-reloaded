  ...
  render() {    
    ...
    return(                             
      ...
      <ul>
          ...
          {quads_localize_data.disableads == 1 ? <li><h2><Link to={'admin.php?page=quads-settings&path=settings_disableadslist'} className={current == 'settings_disableadslist' ? 'quads-nav-link quads-nav-link-active' : 'quads-nav-link'}>{__('Disable Ads List', 'quick-adsense-reloaded')}</Link></h2></li>:''}
