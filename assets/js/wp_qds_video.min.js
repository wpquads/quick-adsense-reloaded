...
function quadsShowAdsById(group__id, videourl, viedo_width, viedo_height, adbyindex, j){
    ...
    if(adbyindex.ad_type == "video_ads"){
        if(data_redirect)
        {
            content +='<div id="btn_close_video">x</div><a href="'+data_redirect+'" target="_blank"><video id="video_frame" width="'+viedo_width+'" height="'+viedo_height+'" controls autoplay muted><source src='+videourl+' type="video/ogg"></video></a>';
        }
        else{
            content +='<div id="btn_close_video">x</div><video id="video_frame" width="'+viedo_width+'" height="'+viedo_height+'" controls autoplay muted><source src='+videourl+' type="video/ogg"></video>';
        }
