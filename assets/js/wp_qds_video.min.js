...
function quadsShowAdsById(group__id, videourl, viedo_width, viedo_height, adbyindex, j){
    ...
    if(adbyindex.ad_type == "video_ads"){
        content +='<div id="btn_close">x</div><video id="video_frame" width="'+viedo_width+'" height="'+viedo_height+'" controls autoplay muted><source src='+videourl+' type="video/ogg"></video>';
