...
function quadsShowAdsById(group__id, videourl, viedo_width, viedo_height, adbyindex, j){
    ...
    switch(adbyindex.ad_type[0]){
        case "v":
            content +='<div id="btn_close">x</div><iframe id="video_frame" width="'+viedo_width+'" height="'+viedo_height+'" src='+videourl+' frameborder="0" autoplay="1" allow="autoplay"></iframe>';
