...
jQuery(document).ready(function ($) {
    if(!document.getElementById("quads_settings[uninstall_on_delete]").checked){
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.style.display="none";
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.previousSibling.style.display="none";
    }
    document.getElementById("quads_settings[uninstall_on_delete]").addEventListener("click", function(){ 
    if (!$(this).prop('checked')){
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.style.display="none";
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.previousSibling.style.display="none";
    }else{
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.style.display="table-row";
        document.getElementById("quads_settings[hide_add_on_disableplugin]").parentElement.parentElement.previousSibling.style.display="table-row";
    }
}); 
