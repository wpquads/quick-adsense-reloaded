    ...
    foreach($ads_list as $ad)
    {
        ...
        {   
            ...
            {	$image=$ad_meta['image_src'][0];
                ...
                $html .='<a imagebanner class="im-'.$org_ad_id.'" target="_blank" href="'.esc_attr($ad_meta['image_redirect_url'][0]). '" rel="nofollow"><img  class="quads_carousel_img" src="'.esc_attr($image).'" alt="'.esc_attr($ad_meta['label'][0]).'"> </a>';  
            }
    ...
    foreach($ads_list as $ad)
    {
        ...
        { 
            ...
            <a href="'.esc_attr($ad['link']).'" target="_blank" rel="nofollow" >
                <img src="'.esc_attr($ad['slide']).'" alt="'.esc_attr($quads_options['ads'][$id]['label']).'">
                </a>
        </figure>';
            }
        }
    ...
    if($total_slides<6)
    {
            ...
            if(isset($ads_list[$new]['slide']))
        {
            ...
            <a href="'.esc_attr($ads_list[$new]['link']).'" target="_blank" rel="nofollow">
                <img src="'.esc_attr($ads_list[$new]['slide']).'" alt="'.esc_attr($quads_options['ads'][$id]['label']).'">
                </a>
        </figure>';
        }
        }
