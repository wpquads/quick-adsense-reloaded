...
function quads_render_floating_ads_async($id) {
    ...
    $position_array =['top-left'=>'position:fixed !important;top:10px;left:10px;','top-right'=>'position:fixed !important;top:10px;right:10px;','bottom-left'=>'position:fixed !important;bottom:10px;left:10px;','bottom-right'=>'position:fixed !important;bottom:10px;right:10px;'];
    
        $html.='<section class="wpquads-3d-container">
    ...
    if($total_slides<6)
    {
        ...
        $html.='</div></section><style>.wpquads-3d-cube .wpquads-3d-item,.wpquads-3d-cube .wpquads-3d-item img{display:block;margin:0;width:100%;height:100%}.wpquads-3d-container{'.$position_array[$floating_position].'width:'.esc_attr($floating_size).'px;height:'.esc_attr($floating_size).'px;border-radius:3px;position:relative;-webkit-perspective:1000px;-moz-perspective:1000px;-ms-perspective:1000px;-o-perspective:1000px;perspective:1000px;-webkit-box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;-moz-box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;}.wpquads-3d-cube{width:100%;height:100%;position:absolute;-webkit-transition:-webkit-transform 1s;-moz-transition:-moz-transform 1s;-o-transition:-o-transform 1s;transition:transform 1s;-webkit-transform-style:preserve-3d;-moz-transform-style:preserve-3d;-ms-transform-style:preserve-3d;-o-transform-style:preserve-3d;transform-style:preserve-3d;-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px);transform:translateZ(-'.esc_attr($floating_size/2).'px)}.wpquads-3d-cube .wpquads-3d-item{position:absolute}.wpquads-3d-item:first-child{-webkit-transform:rotateY(0) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateY(0) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateY(0) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateY(0) translateZ('.esc_attr($floating_size/2).'px);transform:rotateY(0) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-3d-item:nth-child(2){-webkit-transform:rotateX(180deg) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateX(180deg) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateX(180deg) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateX(180deg) translateZ(150px);transform:rotateX(180deg) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-3d-item:nth-child(3){-webkit-transform:rotateY(90deg) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateY(90deg) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateY(90deg) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateY(90deg) translateZ('.esc_attr($floating_size/2).'px);transform:rotateY(90deg) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-3d-item:nth-child(4){-webkit-transform:rotateY(-90deg) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateY(-90deg) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateY(-90deg) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateY(-90deg) translateZ('.esc_attr($floating_size/2).'px);transform:rotateY(-90deg) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-3d-item:nth-child(5){-webkit-transform:rotateX(90deg) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateX(90deg) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateX(90deg) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateX(90deg) translateZ('.esc_attr($floating_size/2).'px);transform:rotateX(90deg) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-3d-item:nth-child(6){-webkit-transform:rotateX(-90deg) translateZ('.esc_attr($floating_size/2).'px);-moz-transform:rotateX(-90deg) translateZ('.esc_attr($floating_size/2).'px);-ms-transform:rotateX(-90deg) translateZ('.esc_attr($floating_size/2).'px);-o-transform:rotateX(-90deg) translateZ('.esc_attr($floating_size/2).'px);transform:rotateX(-90deg) translateZ('.esc_attr($floating_size/2).'px)}.wpquads-slide0-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(0);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(0);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(0);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(0);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(0)}.wpquads-slide1-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-180deg);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-180deg);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-180deg);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-180deg);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-180deg)}.wpquads-slide2-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(-90deg);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(-90deg);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(-90deg);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(-90deg);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(-90deg)}.wpquads-slide3-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(90deg);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(90deg);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(90deg);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(90deg);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateY(90deg)}.wpquads-slide4-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-90deg);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-90deg);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-90deg);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-90deg);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(-90deg)}.wpquads-slide5-active{-webkit-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(90deg);-moz-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(90deg);-ms-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(90deg);-o-transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(90deg);transform:translateZ(-'.esc_attr($floating_size/2).'px) rotateX(90deg)}</style>
        <script>const wpquads_3d_slides=document.querySelectorAll(".wpquads-3d-item"),wpquads_3d_slider=document.getElementById("wpquads-3d-cube");let activeSlide=0;function changeSlide(){wpquads_3d_slider.classList.remove("wpquads-slide"+activeSlide+"-active"),++activeSlide>=wpquads_3d_slides.length&&(activeSlide=0),wpquads_3d_slider.classList.add("wpquads-slide"+activeSlide+"-active")}setInterval(changeSlide,3e3);</script>';
