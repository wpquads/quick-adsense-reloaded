...
function quads_render_floating_ads_async($id) {
    ...
    $position_array =['top-left'=>'position:fixed !important;top:0px;left:10px;','top-right'=>'position:fixed !important;top:0px;right:10px;','bottom-left'=>'position:fixed !important;bottom:34px;left:10px;','bottom-right'=>'position:fixed !important;bottom:34px;right:10px;'];
    
        $html.='<section class="wpquads-3d-container" id="con-'.$id.'">
