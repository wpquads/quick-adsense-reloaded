    ...
    foreach($ads_list as $ad)
    {
        ...
        {   
            ...
            {	$image=$ad_meta['image_src'][0];
                ...
                $html .='<a imagebanner class="im-'.esc_attr($org_ad_id).'" target="_blank" href="'.esc_url($ad_meta['image_redirect_url'][0]). '" rel="nofollow"><img  class="quads_carousel_img" '.$delay_src.'="'.esc_url($image).'" alt="'.esc_attr($ad_meta['label'][0]).'"> </a>';  
            }
