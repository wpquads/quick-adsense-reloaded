	...
	public function getFBTWCounts() {
      ...
      public function getSharesFBTW() {
          global $quads_options;
                $fb_mode = isset($quads_options['facebook_count_mode'])  ? $quads_options['facebook_count_mode'] : '';  
                $post_data = null;
                //$user_data = null;
                $headers = null;
                ...
                //CURLOPT_USERAGENT, 'quadsEngine v.1.1',
                );
       ...
       */
		...
		if ($data) {
			...
			/*$this->data->shares->total += $count;
                        ...
                        QUADS()->logger->info('quadsEngine - URL: ' . $url . ' ' . $service[0] . ': ' . $count);
		} 
		return;
        }
}