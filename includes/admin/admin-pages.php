...
function quads_add_options_link() {
    ...
    if ($create_settings && $quads_mode != 'new') {
        $quads_settings_page = add_submenu_page('options-general.php', __('QUADS Settings', 'quick-adsense-reloaded'), __('QUADS', 'quick-adsense-reloaded'),$quads_permissions, 'quads-settings', 'quads_options_page');
    } else {
