...
<!--		<li><label><input type="radio" name="quads_disable_reason" value="temporary"/><?php _e('It is only temporary', 'quick-adsense-reloaded'); ?></label></li>
		...
		<li><label><input type="radio" name="quads_disable_reason" value="technical issue"/><?php _e('Technical Issue', 'quick-adsense-reloaded'); ?></label></li>
		<li><textarea name="quads_disable_text[]" placeholder="<?php _e('Can we help? Please let us know your issue', 'quick-adsense-reloaded'); ?>"></textarea></li>
