...
function quads_inline_styles() {
    ...
    .quads_click_impression { display: none;} .quads-location, .quads-ads-space{max-width:100%;} @media only screen and (max-width: 480px) {.penci-builder-element .quads-location, .penci-builder-element .quads-ads-space{max-width:340px;}}";
