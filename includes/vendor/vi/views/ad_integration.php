...
<div id="quads-vi-ad-integration">
    <div id="quads-vi-customize-player">
        <!--<form action="options.php" method="post" id="quads-visettings">//-->
            <?php
            $iab = array(
  ...
  array("val0"=>"IAB26-4","val1"=>"Copyright Infringement")
            ...
            <label>Ad Unit*</label>
            <select>
                <?php foreach($iab as $entry){
                echo "<option value='{$entry[0]}' name='$entry[1]]'>$entry[1]</option>"; 
                }?>
                <option value="business" name="quads_vi_ad_settings[ad][iab_cat][]">Business</option>
                <option value="automotive" name="quads_vi_ad_settings[ad][iab_cat][]">Automotive</option>
            </select>
            <br>
            <label>Keywords</label><input type="text" name="quads_vi_ad_settings[ad][keywords]">
            <br>
            <label>IAB Category*</label> 
            <select> 
                <option value="business" name="quads_vi_ad_settings[ad1][iab_cat][]">Business</option>
                <option value="automotive" name="quads_vi_ad_settings[ad1][iab_cat][]">Automotive</option>
            </select>
            <br>
            <label>IAB Category tier 2</label> 
            <select>
                <option value="volvo" name="quads_vi_ad_settings[ad1][iab_cat][]">Select tier 2 category</option>
                <option value="saab" name="quads_vi_ad_settings[ad1][iab_cat][]">Saab</option>
            </select>
            <br>
            <label>Language*</label><input type="text" name="quads_vi_ad_settings[ad1][language]">
            <br>
            <label>Native Background Color</label><input type="text" name="quads_vi_ad_settings[ad1][bg_color]">
            <br>
            <label>Native Text Color</label><input type="text" name="quads_vi_ad_settings[ad1][text_color]">
            <br>
            <label>Native Text Font Family</label><input type="text" name="quads_vi_ad_settings[ad1][txt_font_family]">
            <br>
            <label>Native Text Font Size</label><input type="text" name="quads_vi_ad_settings[ad1][txt_font_size]">
            <br>
            <label>Optional 1</label><input type="text" name="quads_vi_ad_settings[ad1][optional1]">
            <br>
            <label>Optional 2</label><input type="text" name="quads_vi_ad_settings[ad1][optional2]">
            <br>
            <label>Optional 3</label><input type="text" name="quads_vi_ad_settings[ad1][optional3]">
            <br>
            <?php //echo $jsTag; ?>
